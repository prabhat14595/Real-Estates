  ...
  <div class="w3-bar w3-white w3-wide w3-padding w3-card-2">
   <a class="w3-bar-item w3-button w3-left w3-small" onclick="w3_open()"><i class="fa fa-bars" aria-hidden="true"></i></a>
    ...
    <div class="w3-right w3-hide-small">
      ...
      <a href="project1.php" class="w3-bar-item w3-button w3-text-white w3-grey" >Projects</a>
...
<footer class="w3-container w3-padding-64 w3-light-grey w3-center w3-opacity w3-xxlarge">
    ...
    <p class="w3-small">All Right Reserve &copy;<a href="index target="_blank" class="w3-hover-text-green">Purva Devlopers </a></p>
  <!-- End footer -->
  </footer>
