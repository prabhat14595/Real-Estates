...
<nav class="w3-sidebar w3-bar-block w3-card-2 w3-top w3-large w3-animate-left w3-text-grey" style="display:none;z-index:2;width:25%;min-width:260px" id="mySidebar">
  ...
  <a href="#" onclick="w3_close()" class="w3-bar-item w3-button"><span class="fa fa-home w3-bar-item w3-xlarge w3-button w3-text-blue w3-left "></span></a>
...
<!-- Google Map -->
 ...
 <img class="w3-hide-small" src="w3images/capture1.png" style="width:100%;height:550px;">
 <img class="w3-hide-large w3-hide-medium" src="w3images/cap1.png"  alt="maps" style="width: 100%">
</div>
