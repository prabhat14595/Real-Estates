...
<div class="w3-top">
  <div class="w3-bar w3-white w3-wide w3-padding w3-card-2">
    <a href="home.php" class="w3-bar-item w3-button w3-text-lime"><b>PURVA</b> Developers</a>
    ...
    <a href="home.php"><span class="fa fa-home w3-bar-item w3-xlarge w3-button "></span></a>
      ...
      <a href="about1.php" class="w3-bar-item w3-button w3-lime w3-text-white">About</a>
...
<hr>
 ...
 <div class="w3-row-padding w3-grayscale">
    <div class="w3-half w3-margin-bottom">
      ...
      <a href="contact1.php" style="text-decoration: none;"><button class="w3-button w3-light-grey w3-block">contact</button></a>
    </div>
   <div class="w3-half w3-margin-bottom">
